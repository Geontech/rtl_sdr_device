...
pushd cpp
./reconf
%define _bindir %{_prefix}/dev/devices/rtl_sdr_device/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dev/devices/%{name}/rtl_sdr_device.scd.xml
%{_prefix}/dev/devices/%{name}/rtl_sdr_device.prf.xml
%{_prefix}/dev/devices/%{name}/rtl_sdr_device.spd.xml
