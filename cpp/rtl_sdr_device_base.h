...
class rtl_sdr_device_base : public ExecutableDevice_impl
{
    ...
    protected:
        ...
        tuner_allocation_struct tuner_allocation;
        listener_allocation_struct listener_allocation;
        std::vector<tuner_status_struct> tuner_statuses;

        // Ports
        FRONTEND_DigitalTuner_In_i *DigitalTuner_provides;
