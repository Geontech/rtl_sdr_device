...
public:
	BULKIO_dataShort_Out_i_customized(std::string port_name, rtl_sdr_device_base *_parent);
...
{
	public:
        FRONTEND_DigitalTuner_In_i_customized(std::string port_name, rtl_sdr_device_base *_parent);
